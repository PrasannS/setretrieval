...
# nanofiqaeval "output/ModernBERT-base/ModernBERT-base-pylate-pairwise-msmarco-0.0003-qv1-dv100-pqv0-pdv0-embsize128-topk4-alpha4.0/final" 1 100 128 "yes" "paircolbnormalq1d100embsize128topk4alpha4.0" "colbert_faiss" 0 0

# nanofiqaeval "output/ModernBERT-base/ModernBERT-base-pylate-pairwise-msmarco-0.0003-qv1-dv100-pqv0-pdv0-embsize128-topk4-alpha10.0/final" 1 100 128 "yes" "paircolbnormalq1d100embsize128topk4alpha10.0" "colbert_faiss" 0 0

nanofiqaeval "output/ModernBERT-base/ModernBERT-base-pylate-pairwise-msmarco-0.0003-qv1-dv400-pqv0-pdv0-embsize128-topk4-alpha1.0/final" 1 100 128 "yes" "paircolbnormalq1d400embsize128topk4alpha10.0" "colbert_faiss" 0 0