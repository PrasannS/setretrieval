...
torchrun --nproc_per_node=4 scripts/train_pylate_pairwise.py --qvecs 1 --dvecs 100 --passiveqvecs 0 --passivedvecs 0 --embdim 128 --lr 3e-4 --mini_batch_size 16 --topk 4 --alpha 4
torchrun --nproc_per_node=4 scripts/train_pylate_pairwise.py --qvecs 1 --dvecs 100 --passiveqvecs 0 --passivedvecs 0 --embdim 128 --lr 3e-4 --mini_batch_size 16 --topk 4 --alpha 10
torchrun --nproc_per_node=4 scripts/train_pylate_pairwise.py --qvecs 1 --dvecs 400 --passiveqvecs 0 --passivedvecs 0 --embdim 128 --lr 3e-4 --mini_batch_size 16 --topk 4 --alpha 1
torchrun --nproc_per_node=4 scripts/train_pylate_pairwise.py --qvecs 1 --dvecs 400 --passiveqvecs 0 --passivedvecs 0 --embdim 128 --lr 3e-4 --mini_batch_size 16 --topk 4 --alpha 10