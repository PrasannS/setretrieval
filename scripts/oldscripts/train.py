...
"""
import setretrieval.train.retrieval_train as retrieval_train
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_strat", type=str, default="no")
    ...
    parser.add_argument("--gcheck", type=str, default="yes")
    ...
    retrieval_train.train_retriever(traindata, evaldata, model_type=args.traintype, base_model=args.model_name, per_device_batch_size=args.batch_size, num_train_epochs=args.num_epochs, learning_rate=args.learning_rate, dsetname=args.dataset, mini_batch_size=args.batch_size, maxchars=maxchars, div_coeff=args.div_coeff, divq_coeff=args.divq_coeff, colscore=args.colscore, save_strat=args.save_strat, schedtype=args.schedtype, temp=args.temp, othermodel_name=args.othermodel_name, othermod=args.othermod, qvecs=args.querylen, dvecs=args.doclen, dodefaulttrain=args.dodefaulttrain, do_compile=args.compile, lora_rank=args.lora_rank, embsize=args.embsize, gcheck=args.gcheck)